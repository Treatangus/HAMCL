package com.launcher.hamcl.widget;
...
public class MaterialDesignToast extends Toast {
     ...
     */
    public MaterialDesignToast(Context context) {
        super(context);
        mContext = context;
    }

    public static MaterialDesignToast makeText(Context context, String message) {
        return makeText(context, message, LENGTH_SHORT, TYPE_INFO);
    }

    public static MaterialDesignToast makeText(Context context, String message, int duration) {
        return makeText(context, message, duration, TYPE_INFO);
    }

    public static MaterialDesignToast makeText(Context context, String message, int duration, int type) {
        MaterialDesignToast mdToast = new MaterialDesignToast(context);
